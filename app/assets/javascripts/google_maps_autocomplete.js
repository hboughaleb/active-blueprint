function onPlaceChanged() {
  ...
  projectAddress.blur();
  projectAddress.value = components.address;

  document.getElementById('project_zip_code').value = components.zip_code;
  document.getElementById('project_city').value = components.city;

  if (components.country_code) {
    var selector = '#project_country option[value="' + components.country_code + '"]';
